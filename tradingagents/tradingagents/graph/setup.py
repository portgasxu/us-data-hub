...
class GraphSetup:
    ...
    def setup_graph(
        ...
        from tradingagents.agents.managers.contradiction_detector import (
            create_contradiction_detector,
        )
        contradiction_detector_node = create_contradiction_detector(
            self.deep_thinking_llm
        )
        ...
        workflow.add_edge("Contradiction Detector", "Portfolio Manager")
