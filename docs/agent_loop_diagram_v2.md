# 美股自动交易系统 — Agent Loop 架构图 v3.6

> 更新时间: 2026-04-20 20:34
> 更新内容: v3.6 清理 Claude/Anthropic 依赖 + Orchestrator 进程退出误判修复
> 覆盖: JVS大脑 / 订单监控 / 价格采集 / 系统管理器 / 持仓去重 / Pending去重 / Screener-to-Trade 全链路 / 独立复盘晨报 / Claude清理 / 进程退出检测修复
